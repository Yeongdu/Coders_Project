          ...
          <ul class="pagination">
            ...
            <c:choose>
                <c:when test="${ (page - 1) == 0}">
                    <li><a class="page-link" href="qna_search.do?page=1&search_keyword=${searchkeyword }">Previous</a></li>
                </c:when>
                <c:otherwise>
                    <li><a class="page-link" href="qna_search.do?page=${ page - 1 }&search_keyword=${searchkeyword }">Previous</a></li>
                </c:otherwise>
            </c:choose>
            <c:forEach begin="${ startBlock }" end="${ endBlock }" var="i">
                <c:if test="${ i==page }">
                    <li class="page-item active" aria-current="page">
                    <a class="page-link" href="qna_search.do?page=${i }&search_keyword=${searchkeyword }">${i }</a></li>
                </c:if>
                <c:if test="${ i!=page }">
                    <li class="page-item">
                    <a class="page-link" href="qna_search.do?page=${i }&search_keyword=${searchkeyword }">${i }</a></li>
           ...
           <c:if test="${ page < allPage }">
                <li class="page-item">
                <a class="page-link" href="qna_search.do?page=${ page + 1 }&search_keyword=${searchkeyword }">Next</a>
                </li>
                <li class="page-item">
                <a class="page-link" href="qna_search.do?page=${ allPage }&search_keyword=${searchkeyword }">End</a>
                </li>
            </c:if>
          </ul>
        </nav>
