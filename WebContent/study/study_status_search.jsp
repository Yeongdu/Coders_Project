...
<br />
		...
		<nav>
          <ul class="pagination">
            <li class="page-item">
              <a class="page-link" href="study_status_search.do?page=1">First</a></li>
            <c:choose>
                <c:when test="${ (page - 1) == 0}">
                    <li><a class="page-link" href="study_status_search.do?page=1">Previous</a></li>
                </c:when>
                <c:otherwise>
                    <li><a class="page-link" href="study_status_search.do?page=${ page - 1 }">Previous</a></li>
                </c:otherwise>
            </c:choose>
            <c:forEach begin="${ startBlock }" end="${ endBlock }" var="i">
                <c:if test="${ i==page }">
                    <li class="page-item active" aria-current="page">
                    <a class="page-link" href="study_status_search.do?page=${i }">${i }</a></li>
                </c:if>
                <c:if test="${ i!=page }">
                    <li class="page-item">
                    <a class="page-link" href="study_status_search.do?page=${i }">${i }</a></li>
           ...
           <c:if test="${ page < allPage }">
                <li class="page-item">
                <a class="page-link" href="study_status_search.do?page=${ page + 1 }">Next</a>
                </li>
                <li class="page-item">
                <a class="page-link" href="study_status_search.do?page=${ allPage }">End</a>
                </li>
            </c:if>
          </ul>
        </nav>
