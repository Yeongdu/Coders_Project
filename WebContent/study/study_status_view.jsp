		...
		<nav>
			<ul class="pagination">
				<li class="page-item"><a class="page-link"
					href="study_status_view.do?page=1">First</a></li>
				<c:choose>
					...
					<c:otherwise>
						<li><a class="page-link"
							href="study_status_view.do?page=${ page - 1 }">Previous</a></li>
					</c:otherwise>
				</c:choose>
				<c:forEach begin="${ startBlock }" end="${ endBlock }" var="i">
					<c:if test="${ i==page }">
						<li class="page-item active" aria-current="page"><a
							class="page-link" href="study_status_view.do?page=${i }">${i }</a></li>
					</c:if>
					<c:if test="${ i!=page }">
						<li class="page-item"><a class="page-link"
							href="study_status_view.do?page=${i }">${i }</a></li>
					</c:if>
				</c:forEach>
				<c:if test="${ page < allPage }">
					<li class="page-item"><a class="page-link"
						href="study_status_view.do?page=${ page + 1 }">Next</a></li>
					<li class="page-item"><a class="page-link"
						href="study_status_view.do?page=${ allPage }">End</a></li>
				</c:if>
			</ul>
		</nav>
